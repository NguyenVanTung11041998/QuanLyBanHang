...
/**
* DTO/DanhMucHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Model.idl
* Sunday, December 1, 2019 6:05:05 PM ICT
*/

abstract public class DanhMucHelper
{
  private static String  _id = "IDL:DTO/DanhMuc:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (DTO.DanhMucHelper.id (), "DanhMuc", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    DTO.DanhMuc value = new DTO.DanhMuc ();
