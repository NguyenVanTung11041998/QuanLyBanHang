 ...
 implements Corba_DAO.INhaSanXuatDAOOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("UpdateInfo", new java.lang.Integer (4));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // Corba_DAO/INhaSanXuatDAO/UpdateInfo
       {
         int id = in.read_long ();
         String tenNSX = in.read_string ();
         String thongTin = in.read_string ();
         boolean $result = false;
         $result = this.UpdateInfo (id, tenNSX, thongTin);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }

       case 5:  // Corba_DAO/INhaSanXuatDAO/TimKiem
       {
       ...
       case 6:  // Corba_DAO/INhaSanXuatDAO/GetById
       {
         int id = in.read_long ();
         DTO.NhaSanXuat $result = null;
