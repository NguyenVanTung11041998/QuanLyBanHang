...
public class _IHoaDonDAOStub extends org.omg.CORBA.portable.ObjectImpl implements Corba_DAO.IHoaDonDAO
{
  ...
  public DTO.HoaDon GetHoaDonCuoiCungTheoKhachHang (int idKhachHang)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("GetHoaDonCuoiCungTheoKhachHang", true);
                $out.write_long (idKhachHang);
                $in = _invoke ($out);
                DTO.HoaDon $result = DTO.HoaDonHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                return GetHoaDonCuoiCungTheoKhachHang (idKhachHang        );
            } finally {
                _releaseReply ($in);
            }
  } // GetHoaDonCuoiCungTheoKhachHang

  public DTO.HoaDon GetById (int id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
